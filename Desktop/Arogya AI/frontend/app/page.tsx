...
import { BadgeCheck, UploadCloud, AlertTriangle } from 'lucide-react';
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link href="/upload" className="bg-primary text-on-primary font-medium px-8 py-3 rounded-lg hover:scale-95 transition-transform duration-200 shadow-sm flex items-center justify-center gap-2">
                  <UploadCloud className="w-5 h-5" />
                  Upload Report Now
                </Link>
                <button 
                  onClick={handleViewDemo}
                  className="bg-surface text-on-surface font-medium px-8 py-3 rounded-lg border border-outline-variant hover:bg-surface-container transition-all duration-200 flex items-center justify-center gap-2 active:scale-95 hover:shadow-sm"
                >
                  View Demo
                </button>
              </div>
